...
const DEFAULT_EXTENDED_DATA: ExtendedCMSData = {
  ...
  google_analytics_id: '',
  adsense_publisher_id: 'pub-4237790251786919',
  adsense_client_id: 'ca-pub-4237790251786919',
  ads_txt_content: 'google.com, pub-4237790251786919, DIRECT, f08c47fec0942fa0',
  about_us: '',
  privacy_policy: '',
  terms_of_use: '',
};
