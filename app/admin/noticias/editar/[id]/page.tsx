      ...
      try {
        ...
        if (data) {
          setFormData({
            ...
            // City and AI
            city_slug: data.city_slug || 'presidente-prudente',
            city_name: data.city_name || 'Presidente Prudente',
            ...
            ai_viral_potential_score: data.ai_viral_potential_score ?? 50,
            ai_regional_impact_score: data.ai_regional_impact_score ?? 50,
            ai_summary: data.ai_summary || '',
            ai_seo_title: data.ai_seo_title || '',
            ai_seo_description: data.ai_seo_description || '',
          });
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500">Faça modificações na matéria existente do portal multi-cidades.</p>
          </div>
        </div>
